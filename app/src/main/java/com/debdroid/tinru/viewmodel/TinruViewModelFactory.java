...
public class TinruViewModelFactory implements ViewModelProvider.Factory {
    private final Map<Class<? extends ViewModel>, Provider<ViewModel>> creators;

    @Inject
    public TinruViewModelFactory(Map<Class<? extends ViewModel>, Provider<ViewModel>> creators) {
